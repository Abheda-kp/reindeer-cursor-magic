...
const downloadOptions = [
  {
    ...
    icon: "apple",
    versions: [
      { name: "Mac (ARM64)", arch: "ARM64", downloadUrl: "https://reindeer.t3.storage.dev/builds/Reindeer-1.0.4-arm64.dmg" },
      { name: "Mac (x64)", arch: "x64", downloadUrl: "https://reindeer.t3.storage.dev/builds/Reindeer-1.0.4.dmg" },
    ],
  },
  {
    os: "Linux",
    ...
    versions: [
      { name: "Linux .deb (ARM64)", arch: "ARM64", downloadUrl: null },
      {
        name: "Linux .deb (x64)",
        arch: "x64",
        downloadUrl: "https://reindeer.t3.storage.dev/reindeer_1.0.4_amd64.deb",
      },
